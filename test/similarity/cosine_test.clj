...
(deftest test-cosine-similarity
  (is (about= 0.909090 (text-similarity "The quick brown dog jumps over the brown fox"
                                        "The quick brown canine jumps over the brown fox")))

  (is (about= 1.0 (text-similarity "The quick brown dog jumps over the brown fox"
